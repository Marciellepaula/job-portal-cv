...
<div class="template cv-roma active" data-template-color="dark" data-template-id="roma" style="">
    <div class="export_cv print" data-cv-print-area="" style="">
        <div data-cv-step="step1_preview" class="sidebar">
            <span class="user-img">
                <img class="preview-avatar-img" src="https://cdn.todacarreira.com/img/avatar.jpg" alt="Foto do perfil">
            </span>
