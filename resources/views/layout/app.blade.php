...
<body>
    <nav class="navbar fixed-top navbar-expand-lg p-2 bg-white" style="border-bottom: solid 0px #d9d9d9">
        <a class="navbar-brand pl-4" href="/" style="color: rgb(25, 25, 25);">
            <img src="https://www.pinclipart.com/picdir/big/198-1980971_sixdays-bremen-transparent-loading-circle-gif-clipart.png"
                width="25px" height="25px" /><b> pportunity</b>
        </a>
    ...
    <div class="row" id="footer" style="margin: 0; padding-left:; padding-top: 3% ;list-style: none;">
        ...
        <div class="col-lg-12" style="color: rgb(25, 25, 25);">
            <img src="https://www.pinclipart.com/picdir/big/198-1980971_sixdays-bremen-transparent-loading-circle-gif-clipart.png"
                width="20px" height="20px" /><b> pportunity</b>
        </div>
