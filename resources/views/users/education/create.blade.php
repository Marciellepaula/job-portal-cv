...
@section('content')
    ...
    <body>
        <div class="container-fluid p-5 " style="margin-top: 5%">
            ...
            <form action="/users/education/store" method="post" class="card p-4 m-2 p-4 mb-5"
                style='background-color: rgb(253, 253, 253); border:none; border-radius: 1% '>
                @csrf
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-1 mt-2">
                        <button type="submit"
                            class=" form-control btn btn-sm btn btn-primary font-weight-bold">Save</button>
                    </div>
                </div>
            </form>
        </div>
