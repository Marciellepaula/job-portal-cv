                ...
                <div class="">
                    <p class="text-center">
                        <img class="rounded-circle" alt="100x100"
                            src="https://pngimage.net/wp-content/uploads/2018/05/dummy-profile-image-png.png" width="150px"
                            height="150px" data-holder-rendered="true">
                    </p>
                ...
                <ul style=" list-style-position: outside;">
                    @foreach ($education as $user_education)
                        <li style=" list-style-position: outside;">
                            <label><b>{{ $user_education->degree_name }} - {{ $user_education->institute }} -
                                    {{ $user_education->location }}</b></label><br>
                            <label>{{ $user_education->subject }} - Passing Year:
                                {{ date('F Y', strtotime($user_education->passing_year) + 6 * 3600) }} - Result:
                                {{ $user_education->result }}</label>
                        </li>
                    @endforeach
                </ul>
